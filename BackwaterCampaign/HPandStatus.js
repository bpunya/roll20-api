...
var HPandStatus = HPandStatus || (function () {
  ...
  var getHPStatus = function (obj, prev) {
    if (!prev) { prev = obj }
    var HP = {
  ...
  var statusChange = function (obj, prev) {
